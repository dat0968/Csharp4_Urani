...
{
    /// <inheritdoc />
    public partial class DatabaseVersionNew : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HD001", "123 Đường A, Quận 1", "Nguyễn Văn A", "COD", "KH001", "NV001", "Hóa đơn đầu tiên", new DateOnly(2024, 11, 13), "0123456789", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 15), "Đã thanh toán" },
                    { "HD002", "456 Đường B, Quận 2", "Trần Thị B", "COD", "KH002", "NV002", "Hóa đơn thứ hai", new DateOnly(2024, 11, 13), "0987654321", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 16), "Đã thanh toán" },
                    { "HD003", "789 Đường C, Quận 3", "Nguyễn Thị C", "COD", "KH003", "NV003", "Hóa đơn thứ ba", new DateOnly(2024, 11, 13), "0912345678", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 14), "Đã thanh toán" },
                    { "HD004", "321 Đường D, Quận 4", "Lê Văn D", "COD", "KH004", "NV001", "Hóa đơn thứ tư", new DateOnly(2024, 11, 13), "0123456789", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 18), "Đã thanh toán" },
                    { "HD005", "654 Đường E, Quận 5", "Nguyễn Văn E", "COD", "KH005", "NV002", "Hóa đơn thứ năm", new DateOnly(2024, 11, 13), "0987654321", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 15), "Đã thanh toán" },
                    { "HD006", "987 Đường F, Quận 6", "Trần Thị F", "COD", "KH006", "NV003", "Hóa đơn thứ sáu", new DateOnly(2024, 11, 13), "0912345678", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 16), "Đã thanh toán" },
                    { "HD007", "159 Đường G, Quận 7", "Nguyễn Văn G", "COD", "KH007", "NV001", "Hóa đơn thứ bảy", new DateOnly(2024, 11, 13), "0123456789", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 17), "Đã thanh toán" },
                    { "HD008", "753 Đường H, Quận 8", "Lê Thị H", "COD", "KH008", "NV002", "Hóa đơn thứ tám", new DateOnly(2024, 11, 13), "0987654321", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 15), "Đã thanh toán" },
                    { "HD009", "258 Đường I, Quận 9", "Nguyễn Văn I", "COD", "KH009", "NV003", "Hóa đơn thứ chín", new DateOnly(2024, 11, 13), "0912345678", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 18), "Đã thanh toán" },
                    { "HD010", "369 Đường J, Quận 10", "Trần Văn J", "COD", "KH010", "NV001", "Hóa đơn thứ mười", new DateOnly(2024, 11, 13), "0123456789", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 16), "Đã thanh toán" },
                    { "HD011", "123 Đường K, Quận 11", "Lê Thị K", "COD", "KH011", "NV002", "Hóa đơn thứ mười một", new DateOnly(2024, 11, 13), "0987654321", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 15), "Đã thanh toán" },
                    { "HD012", "456 Đường L, Quận 12", "Nguyễn Văn L", "COD", "KH012", "NV003", "Hóa đơn thứ mười hai", new DateOnly(2024, 11, 13), "0912345678", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 18), "Đã thanh toán" },
                    { "HD013", "789 Đường M, Quận 1", "Lê Văn M", "COD", "KH013", "NV001", "Hóa đơn thứ mười ba", new DateOnly(2024, 11, 13), "0123456789", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 15), "Đã thanh toán" },
                    { "HD014", "321 Đường N, Quận 2", "Nguyễn Thị N", "COD", "KH013", "NV002", "Hóa đơn thứ mười bốn", new DateOnly(2024, 11, 13), "0987654321", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 16), "Đã thanh toán" },
                    { "HD015", "654 Đường O, Quận 3", "Lê Văn O", "COD", "KH013", "NV003", "Hóa đơn thứ mười lăm", new DateOnly(2024, 11, 13), "0912345678", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 17), "Đã thanh toán" },
                    { "HD016", "987 Đường P, Quận 4", "Nguyễn Văn P", "COD", "KH013", "NV001", "Hóa đơn thứ mười sáu", new DateOnly(2024, 11, 13), "0123456789", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 15), "Đã thanh toán" },
                    { "HD017", "159 Đường Q, Quận 5", "Trần Thị Q", "COD", "KH013", "NV002", "Hóa đơn thứ mười bảy", new DateOnly(2024, 11, 13), "0987654321", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 16), "Đã thanh toán" },
                    { "HD018", "753 Đường R, Quận 6", "Lê Văn R", "COD", "KH013", "NV003", "Hóa đơn thứ mười tám", new DateOnly(2024, 11, 13), "0912345678", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 17), "Đã thanh toán" },
                    { "HD019", "258 Đường S, Quận 7", "Nguyễn Thị S", "COD", "KH013", "NV001", "Hóa đơn thứ mười chín", new DateOnly(2024, 11, 13), "0123456789", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 15), "Đã thanh toán" },
                    { "HD020", "369 Đường T, Quận 8", "Lê Văn T", "COD", "KH013", "NV002", "Hóa đơn thứ hai mươi", new DateOnly(2024, 11, 13), "0987654321", new DateOnly(2024, 11, 13), new DateOnly(2024, 11, 16), "Đã thanh toán" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "MaChiTietHoaDon", "ChatLieu_ThuocTinhSuyDien", "DonGia", "KichThuoc_ThuocTinhSuyDien", "MaHoaDon", "MaSp", "MauSac_ThuocTinhSuyDien", "SoLuongMua" },
                values: new object[,]
                {
                    { 1, "Da Thật", 150000.0, "Nhỏ", "HD001", "SP001", "Đỏ", 2 },
                    { 2, "Vải", 200000.0, "Trung Bình", "HD002", "SP002", "Xanh", 1 },
                    { 3, "Nhựa", 250000.0, "Lớn", "HD003", "SP003", "Vàng", 3 },
                    { 4, "Vải", 120000.0, "Nhỏ", "HD004", "SP004", "Trắng", 5 },
                    { 5, "Cotton", 175000.0, "Trung Bình", "HD005", "SP005", "Đen", 2 },
                    { 6, "Vải", 300000.0, "Lớn", "HD006", "SP006", "Đỏ", 1 },
                    { 7, "Da Thật", 250000.0, "Nhỏ", "HD007", "SP007", "Xanh", 3 },
                    { 8, "Cotton", 220000.0, "Trung Bình", "HD008", "SP008", "Vàng", 4 },
                    { 9, "Nhựa", 275000.0, "Lớn", "HD009", "SP009", "Trắng", 2 },
                    { 10, "Vải", 180000.0, "Nhỏ", "HD010", "SP010", "Đen", 1 }
                });
